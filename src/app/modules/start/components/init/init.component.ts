...
export class InitComponent implements OnInit {
  ...
  game: AnimationOptions = {
    path: '/assets/Animations/gamer.json',
  };
  ...
  ngOnInit(): void {
    ...
    this.actions$
      .pipe(ofActionSuccessful(SetGameState))
      .subscribe((payload) => {
        ...
        if (doc.exists) {
          ...
          if (doc.data().name && doc.data().image) {
            ...
            this.store.dispatch([
              ...
              new ChangeGameState('homescreen'),
              new ListenToGameState(),
            ]);
          }
        } else {
          this.store.dispatch([
        ...
        .subscribe((doc) => {
          ...
          if (doc.exists) {
            ...
            if (doc.data().name && doc.data().image) {
              ...
              this.store
                .dispatch([
                  new SetHostByPlayer(this.hostId),
                  new InitializePlayer(
                    doc.data().name,
                    this.hostId,
                    doc.data().image
